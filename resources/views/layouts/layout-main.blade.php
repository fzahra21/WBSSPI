...
<body>
    ...
    <script src="{{asset('/tema/asset/vendor/apexcharts/apexcharts.min.js')}}"></script>
    <script src="{{asset('/tema/asset/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('/tema/asset/vendor/chart.js/chart.umd.js')}}"></script>
    <script src="{{asset('/tema/asset/vendor/echarts/echarts.min.js')}}"></script>
    <script src="{{asset('/tema/asset/vendor/quill/quill.min.js')}}"></script>
    <script src="{{asset('/tema/asset/vendor/simple-datatables/simple-datatables.js')}}"></script>
    <script src="{{asset('/tema/asset/vendor/tinymce/tinymce.min.js')}}"></script>
    <script src="{{asset('/tema/asset/vendor/php-email-form/validate.js')}}"></script>

    <script src="{{asset('/tema/asset/js/main.js')}}"></script>
</body>
</html>