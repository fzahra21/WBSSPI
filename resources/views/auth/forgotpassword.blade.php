            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="pt-4 pb-2">
                        ...
                        <p class="text-center small">Enter the email address of your account registered with LASPIKA </p>
                    </div>

                  <form method="post" action="{{'/forgotpassword'}}" class="row g-3 needs-validation" novalidate>
                    @csrf
                    ...
                    <div class="col-12">
                        <label for="password" class="form-label">Confirmation New Password</label>
                        <input type="password" name="password" class="form-control" id="password" required>
                    ...
                    <div class="col-12">
                        <p class="small mb-0"><a href="{{('/login')}}">Log in</a></p>
                      </div>
                  </form>
